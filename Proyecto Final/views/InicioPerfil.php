...
<body>
			...
			<div class="align-self-center ml-auto">
				<ul class="u-list-inline">
					<li class="list-inline-item g-mr-5">
						<a style="color:white;margin-top: -8px;margin-right:-95px" class="movimientos3" href="Conexiones/logout.php"><h4>Cerrar Sesion</h4></a>
					</li>
				</ul>
			</div>
		</div>
	...
	<header>
		...
		<div class="contenedor">
			<h1 class="titulo"><?php echo $_SESSION['usuario']?> </h1>
		</div>
	</header>

	
 <a style="color:white;" href="subir.php" class="btn btn-primary tam"><h4 style="margin-top:5px;">Subir Foto</h4></a> 
 <a style="color:white;margin-left:148px;" href="fotos.php" class="btn btn-primary tam"><h4 style="margin-top:5px;">Inicio</h4></a>   
